...
def copy_layer(jobname, old_layer_name):#jobname, org_layer_index, dst_layer, poi_layer_index
    ...
    try:
        ...
        ret2 = epcam_api.copy_layer(jobname, old_layer_index, dst_layer, blank_index)
...
def copy_step(job, old_step_name):
    ...
    try:
        ...
        #新建空
        # create_step(job, 'jbz')
        ret2 = epcam_api.copy_step(job, old_step_index, dst_step, blank_index)
        data2 = json.loads(ret2)
    ...
    for root, dirs, files in os.walk(file_path):
        ...
        for file in files:
            ...
            if file_format == 'Gerber274x' or file_format == 'Excellon2' or file_format == 'DXF':
                print(file)
                re = epcam_api.file_translate(os.path.join(root, file), job, step, file_name, file_param, '', '', '', [])    #translate
