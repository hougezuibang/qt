...
#导出 unit:0:trailing 1:leading 2:none      mirror|mirrordirection:False|"No"   \  True|"X"
...
def rout2file(job, step, layer,path,number_format_l=2,number_format_r=4,
                    ...
                    , num_in_x = 0, num_in_y = 0, order_type = 0, serial_no = 0, break_arcs = False, manufacator = '',break_sr = False):
    data = {
        'func': 'ROUT2FILE',
        'paras': {
            'job': job,
...
def output_pdf(job,step,layers,backcolor,layercolors,overlap,pdfname,outputpath):
    data = {
        'func': 'OUTPUT_PDF',
        'paras': {
                    'job': job,
...
def output_dxf(job,step,layers,outputpath):
    data = {
        'func': 'DXF2FILE',
        'paras': {
                    'job': job,
...
def distance_of_polygon(polygon1,polygon2):
    data = {
        'func': 'DISTANCE_OF_POLYGON',
        'paras': {
                    'polygon1': polygon1,
                    'polygon2': polygon2
                      }   
...
def display_layers(jobname, stepname, clayer = '', snaplayer = '', displaylayers = [], affectedlayers = []):
    data = {
        'func': 'DISPLAY_LAYERS',
        'paras': {
                'jobname': jobname,
